    ...
    eventCore = hAzzle.eventCore = {
            ...
            if (!(eventHandle = elemData.handle)) {
                ...
                eventHandle = elemData.handle = function (e) {
                    return typeof hAzzle !== undefined && eventCore.triggered !== e.type ?
                        //                        eventCore.dispatch.apply(elem, arguments) : undefined;
                        eventCore.dispatch.apply(this, arguments) : undefined;
                };
            }
        ...
        remove: function (elem, types, handler, selector, mappedTypes) {
            ...
            while (t--) {
                ...
                if (!type) {
                    for (type in events) {
                        eventCore.remove(elem, type + types[t], handler, selector, true);
                    }
                    continue;
                }
        ...
        trigger: function (evt, data, elem, onlyHandlers) {
            ...
            // Caller can pass in a hAzzle.Event object, Object, or just an event type string
            ...
            evt.namespace_re = evt.namespace ?
			...
			data = hAzzle.makeArray(data, [evt]);
        ...
        dispatch: function (event) {
            ...
            // Make a writable hAzzle.Event from the native event object
            event = hAzzle.props.propFix(event);
            ...
            var i, j, ret, matched, handleObj,
                ...
                handlers = (hAzzle.data(this, 'events') || {})[event.type] || [],
                special = eventHooks.special[event.type] || {};
            ...
            // Determine handlers
            handlerQueue = eventCore.handlers.call(this, event, handlers);
...
hAzzle.extend({
    ...
    on: function (types, selector, data, fn, /*INTERNAL*/ one) {
        ...
        return this.each(function () {
            eventCore.add(this, types, fn, data, selector);
        });
    },
    ...
    off: function (types, selector, fn) {
        ...
        return this.each(function () {
            eventCore.remove(this, types, fn, selector);
        });
    },

    trigger: function (type, data) {
        return this.each(function () {
            eventCore.trigger(type, data, this);
        });
    },
    triggerHandler: function (type, data) {
        var elem = this[0];
        if (elem) {
            return eventCore.trigger(type, data, elem, true);
        }
    }
});
