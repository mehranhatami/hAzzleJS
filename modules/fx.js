...
hAzzle.fn.extend({
    ...
    fadeIn: function (sets, callback) {
        ...
        sets['fadeIn'] = true;
        sets['display'] = getDisplay(this, el); // NOTE!! This will give an error. I will fix this ASAP!!

        return this.each(function () {
            fadeIt(this, 'fadeIn', sets || {}, callback);
        });
    ...
    fadeOut: function (sets, callback) {
