...
(function (window, undefined) {
  ...
  hAzzle.extend({
    ...
    createCallback: function (func, thisArg, argCount) {
      ...
      var source = toString.call(func),
        hasThis = reThis.test(source);

      // exit early if there are no `this` references
      if (hasThis === false) {
        return func;
      }

      //use argCount to use call instead of apply, since call is much faster than apply
      switch (argCount) {
      case 1:
      ...
      case 3:
        return function (a, b, c) {
          return func.call(thisArg, a, b, c);
        };
      case 4:
        return function (a, b, c, d) {
          return func.call(thisArg, a, b, c, d);
        };
      }
